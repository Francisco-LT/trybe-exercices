function verificarPalindromo (palavra) {
    ...
    for (let index in arrayDeLetras) {
        //array de letras no caso é a palavra qu escolhemos, serão comparadas letra por letra para entender se é ou não um palíndromo
...
console.log(verificarPalindromo("socorrammesubinoonibusemmarrocos")); //false
